...
class ApplicationSidebar extends React.Component {
  ...
  getPath(path) {
    // console.log("in dir -- what is this.props.locagion?" + JSON.stringify(this.props.location ));
            ...
            <Col xs={12}>
              ...
              <div className="sidebar-nav-container">
                <SidebarNav style={{ marginBottom: 0 }} ref={c => this._nav = c}>
                  ...
                  <SidebarNavItem
                    glyph="icon-stroke-gap-icons-Blog"
                    name={
                      <span>
                        Accounts
                        {" "}
                        <Label className="bg-darkcyan fg-white">
                          {result.length}
                        </Label>
                      </span>
                    }
               ...
               <SidebarNavItem glyph='icon-stroke-gap-icons-Blog' name={<span>Accounts <Label className='bg-darkcyan fg-white'>{result.length}</Label></span>}>
                  ...
                  <SidebarNavItem
                    ...
                    href={::this.getPath("usermanagement")}
                  />
                  <SidebarNavItem
                    glyph="icon-simple-line-icons-layers float-right-rtl"
                    name="Store Management"
                    href={::this.getPath("storemanagement")}
                  />

                  {/*<SidebarNavItem glyph='icon-feather-share' name='Campaigns' href={::this.getPath('campaigns/fucker')} /> */}

                  {/*<SidebarNavItem
                    glyph="icon-feather-share"
                    name="Reports"
                    href={::this.getPath("social")}
                  />*/}

                  <SidebarNavItem
                    glyph="icon-pixelvicon-photo-gallery"
                    name="Gallery"
                    href={::this.getPath("gallery")}
                  />
                ...
                {/*  <div className="sidebar-header">DOCUMENTATION</div>
                  ...
                  >
                    <a
                      href="http://rubix-docs.sketchpixy.com"
                      style={{ height: 45 }}
                    >
...
export default class SidebarContainer extends React.Component {
  ...
  render() {
    var userName = cookie.load('name') || 'admin';
    return (
      <div id='sidebar'>
        <div id='avatar'>
          <Grid>
            <Row className='fg-white'>
              <Col xs={4} collapseRight>
                <Avatar name={userName} size={40} style={{marginTop:15}}textSizeRatio={1.75} round={true}/>
                {/*<img src='/imgs/app/avatars/avatar19.png' width='40' height='40' />*/}
              </Col>
              <Col xs={8} collapseLeft id='avatar-col'>
              <div style={{top: 27, fontSize: 19, lineHeight: 1, position: 'relative'}}>{userName}</div>
                <div>
